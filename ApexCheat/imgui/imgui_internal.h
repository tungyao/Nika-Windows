...
#endif
// - ImMin/ImMax/ImClamp/ImLerp/ImSwap are used by widgets which support variety of types: signed/unsigned int/uint64_t uint64_t float/double
...
// Helper: ImVec2ih (2D vector, half-size integer, for uint64_t-term packed storage)
struct ImVec2ih
{
    short   x, y;
